...
export default function Hero() {
  return (
    <section className="relative w-full min-h-screen bg-[#D7D7D7] font-sans overflow-hidden">
        ...
        <div className="w-[48%] flex flex-col justify-between p-10 lg:p-16 xl:p-20 z-10">
          ...
          <div className="my-auto py-8">
            ...
            <a
              ...
              download
              className="mt-6 inline-block rounded-sm bg-[#C4C4C4] px-6 py-3 text-sm font-bold tracking-wide text-black shadow-[inset_-2px_-2px_4px_rgba(255,255,255,0.8),inset_2px_2px_4px_rgba(0,0,0,0.2)] transition hover:bg-gray-300"
            >
              DOWNLOAD CV
            </a>
          </div>
      ...
      {/* 📱 MOBILE LAYOUT */}
      {/* ========================================================= */}
      <div className="flex md:hidden flex-col w-full h-svh bg-black relative justify-between overflow-hidden">
        ...
        <div className="relative z-10 w-full mt-auto bg-[#1A1A1A]/90 backdrop-blur-md p-6 pt-8 pb-8 flex justify-between items-end [clip-path:polygon(0_15%,100%_0,100%_100%,0%_100%)] border-t border-white/10">
          ...
          <div className="flex flex-col gap-2.5">
            ...
            <a
              ...
              className="w-8 h-8 rounded-full border border-white/40 flex items-center justify-center text-white text-xs hover:bg-white hover:text-black transition"
            >
              CV
            </a>
          </div>
